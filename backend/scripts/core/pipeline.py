...
from calibration.calibration import CalibrationModel
from gaze.gaze_estimation import estimate_gaze, GazeStabilizer
from drift.drift_correction import OnlineDriftCorrector
from analytics.analytics_reporting import AnalyticsReporter
from performance.performance_tuning import PerformanceProfiler, fast_loop
from end2end.end2end_model import End2EndGazeModel
...
def process_pipeline(frame, ts, calibration_model, stabilizer, drift_corrector, analytics_reporter, end2end_model=None):
    ...
    # 4. Calibration/Gaze
    if calibration_model.is_fitted and features is not None:
